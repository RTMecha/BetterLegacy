...
namespace BetterLegacy.Editor.Data
{
    ...
    public class KeybindProfile : PAObject<KeybindProfile>, IFile
    {
        ...
        public static List<Keybind> GetDefaultKeybinds() => new List<Keybind>()
        {
            ...
            new Keybind(nameof(KeybindEditor.Paste), new Keybind.Key(Keybind.Key.Type.Pressed, KeyCode.LeftControl), new Keybind.Key(Keybind.Key.Type.Down, KeyCode.V)),
            new Keybind(nameof(KeybindEditor.Duplicate), new Keybind.Key(Keybind.Key.Type.Pressed, KeyCode.LeftControl), new Keybind.Key(Keybind.Key.Type.Down, KeyCode.D)),
