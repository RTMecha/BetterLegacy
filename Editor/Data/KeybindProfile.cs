...
namespace BetterLegacy.Editor.Data
{
    ...
    public class KeybindProfile : PAObject<KeybindProfile>, IFile
    {
        ...
        public static List<Keybind> GetDefaultKeybinds() => new List<Keybind>()
        {
            ...
            new Keybind(nameof(KeybindEditor.AddPitch), new List<Setting> { new Setting("Pitch", "0.1", ValueType.Float) }, new Keybind.Key(Keybind.Key.Type.Down, KeyCode.UpArrow)),
            new Keybind(nameof(KeybindEditor.AddPitch), new List<Setting> { new Setting("Pitch", "-0.1", ValueType.Float) }, new Keybind.Key(Keybind.Key.Type.Down, KeyCode.DownArrow)),
