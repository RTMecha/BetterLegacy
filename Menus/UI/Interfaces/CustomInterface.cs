...
namespace BetterLegacy.Menus.UI.Interfaces
{
    ...
    /// </summary>
    public class CustomInterface : BaseInterface
    {
                ...
                switch (type.Value.ToLower())
                {
                    case "chat": {
                            ...
                            customMenu.elements.Add(new MenuButton
                            {
                                ...
                                iconPath = AssetPack.GetFile("core/sprites/icons/operations/up.png"),
                                color = 6,
                            ...
                            customMenu.elements.Add(new MenuButton
                            {
                                ...
                                iconPath = AssetPack.GetFile("core/sprites/icons/operations/down.png"),
                                color = 6,
