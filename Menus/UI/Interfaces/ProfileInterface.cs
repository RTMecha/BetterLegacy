...
{
    /// <summary>
    /// Interface for displaying user save data.
    /// </summary>
    public class ProfileInterface : BaseInterface
    {
        /// <summary>
        /// The current <see cref="ProfileInterface"/>.
        /// </summary>
        public static ProfileInterface Current { get; set; }

        /// <summary>
        /// Initializes <see cref="ProfileInterface"/>.
        /// </summary>
