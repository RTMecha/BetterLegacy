...
namespace BetterLegacy.Core.Data.Network
{
    ...
    public class Transport : Exists, ISocketManager, IConnectionManager
    {
        ...
        public void SendMessageToServer(ArraySegment<byte> data, SendType sendType = SendType.Reliable) => client?.Connection.SendMessage(data.Array, data.Offset, data.Count, sendType);
