...
namespace BetterLegacy.Core.Data.Network
{
    ...
    public static class Packet
    {
        ...
        public static List<T> CreatePacketList<T>(NetworkReader reader) where T : IPacket, new()
        {
            var list = new List<T>();
        ...
        public static Dictionary<TKey, TValue> CreatePacketDictionary<TKey, TValue>(NetworkReader reader, Func<TKey> getKey) where TValue : IPacket, new()
        {
