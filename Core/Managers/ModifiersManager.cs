...
namespace BetterLegacy.Core.Managers
{
    public class ModifiersManager : MonoBehaviour
    {
        ...
        public List<Modifier> defaultPlayerModifiers = new List<Modifier>
        {
            ...
            new Modifier(ModifierCompatibility.FullPlayerCompatible, Modifier.Type.Action, nameof(ModifierActions.getHealth), false, "HEALTH_VAR"),
            new Modifier(ModifierCompatibility.FullPlayerCompatible, Modifier.Type.Action, nameof(ModifierActions.getMaxHealth), false, "MAX_HEALTH_VAR"),
            new Modifier(ModifierCompatibility.FullPlayerCompatible, Modifier.Type.Action, nameof(ModifierActions.getIndex), false, "INDEX_VAR"),
            new Modifier(ModifierCompatibility.FullPlayerCompatible, Modifier.Type.Action, nameof(ModifierActions.getMove), false, "MOVE_X_VAR", "MOVE_Y_VAR", "True"),
            new Modifier(ModifierCompatibility.FullPlayerCompatible, Modifier.Type.Action, nameof(ModifierActions.getMoveX), false, "MOVE_X_VAR", "True"),
            new Modifier(ModifierCompatibility.FullPlayerCompatible, Modifier.Type.Action, nameof(ModifierActions.getMoveY), false, "MOVE_Y_VAR", "True"),
