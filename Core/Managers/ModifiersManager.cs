...
namespace BetterLegacy.Core.Managers
{
    public class ModifiersManager : MonoBehaviour
    {
        ...
        {
            new Modifier(ModifierCompatibility.PAPlayerCompatible, Modifier.Type.Action, "setCustomObjectActive", true, "False", "0", "True"),
            ...
            new Modifier(ModifierCompatibility.PAPlayerCompatible, Modifier.Type.Action, "hit", false, "0"),
            ...
            new Modifier(ModifierCompatibility.PAPlayerCompatible, Modifier.Type.Action, "getHealth", false, "HEALTH_VAR"),
            new Modifier(ModifierCompatibility.PAPlayerCompatible, Modifier.Type.Action, "getMaxHealth", false, "MAX_HEALTH_VAR"),
            new Modifier(ModifierCompatibility.PAPlayerCompatible, Modifier.Type.Action, "getIndex", false, "INDEX_VAR"),
