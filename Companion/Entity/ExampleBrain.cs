...
namespace BetterLegacy.Companion.Entity
{
    ...
    public class ExampleBrain : ExampleModule<ExampleBrain>
    {
        ...
        public Vector2 LookingAt
        {
            get
            {
                if (!Cursor.visible && !PlayerManager.inst.players.IsEmpty())
                {
                    var player = PlayerManager.inst.players[0];
        ...
        public void SelectObject(Image image)
        {
            ...
            if (ProjectArrhythmia.State.InEditor && rect.Overlaps(EditorManager.RectTransformToScreenSpace(EditorLevelManager.inst.OpenLevelPopup.GameObject.transform.Find("mask").AsRT())))
        ...
        public virtual void RegisterChecks()
        {
            ...
            checks.Add(new ExampleCheck(Checks.HAS_NOT_LOADED_LEVEL, () => ProjectArrhythmia.State.InEditor && !EditorManager.inst.hasLoadedLevel && !EditorLevelManager.inst.LevelPanels.IsEmpty()));
            checks.Add(new ExampleCheck(Checks.HAS_LOADED_LEVEL, () => ProjectArrhythmia.State.InEditor && EditorManager.inst.hasLoadedLevel));
            ...
            checks.Add(new ExampleCheck(Checks.NO_EDITOR_LEVELS, () => ProjectArrhythmia.State.InEditor && EditorLevelManager.inst.LevelPanels.IsEmpty()));
        ...
        public class Functions : JSONFunctionParser<ExampleBrain>
        {
            ...
            public override void RegisterFunctions()
            {
                ...
                RegisterAction(SetCanDance);
            }

            public void SetAttribute(JSONNode parameters, ExampleBrain thisElement = null, Dictionary<string, JSONNode> customVariables = null)
            {
            ...
            public void SetAttributeOperation(JSONNode parameters, ExampleBrain thisElement = null, Dictionary<string, JSONNode> customVariables = null)
            {
                if (parameters == null || !thisElement)
                    return;
            ...
            public void SetCanDance(JSONNode parameters, ExampleBrain thisElement = null, Dictionary<string, JSONNode> customVariables = null)
            {
