...
namespace BetterLegacy.Companion.Entity
{
    public class ExampleTutorials : ExampleModule<ExampleTutorials>
    {
        ...
        public override void RegisterFunctions()
        {
            ...
            if (AssetPack.TryReadFromFile("companion/tutorials/behavior.json", out string behaviorFile))
        ...
        public class Functions : JSONFunctionParser<ExampleTutorials>
        {
            ...
            public void SetAttribute(JSONNode parameters, ExampleTutorials thisElement = null, Dictionary<string, JSONNode> customVariables = null)
            {
            ...
            public void SetAttributeOperation(JSONNode parameters, ExampleTutorials thisElement = null, Dictionary<string, JSONNode> customVariables = null)
            {
                if (parameters == null || !thisElement)
                    return;
