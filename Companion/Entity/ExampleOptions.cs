...
namespace BetterLegacy.Companion.Entity
{
    ...
    public class ExampleOptions : ExampleModule<ExampleOptions>
    {
        ...
        public override void InitDefault()
        {
            ...
            {
                var active = reference.commands.Active;
                if (!active)
                    reference.chatBubble.Say("What do you want to talk about?");

                reference.commands.Toggle();
            }));
        ...
        public class Functions : JSONFunctionParser<ExampleOptions>
        {
            ...
            public void SetAttribute(JSONNode parameters, ExampleOptions thisElement = null, Dictionary<string, JSONNode> customVariables = null)
            {
            ...
            public void SetAttributeOperation(JSONNode parameters, ExampleOptions thisElement = null, Dictionary<string, JSONNode> customVariables = null)
            {
                if (parameters == null || !thisElement)
                    return;
