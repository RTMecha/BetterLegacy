...
## Changes
### Core
- Removed the "Global" toggle from the playSound modifiers as Asset Packs exist now.
- BREAKING CHANGE!  
...
- Fixed Server Visibility label in the MetaData Editor dialog appearing above the Server / Arcade section label.
...
- Added setPlayerMask modifiers. Similar to setMask, but for players.
...
### Editor
- Made copying and pasting more consistent for Animations, Editor Groups and Pinned Editor Layers.
